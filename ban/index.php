    ...
    <body>
        ...
        <main>
            <div id="content">
                ...
                if ($uid_ban) {
                    $sql_ban = "INSERT INTO banned_users VALUES (?);";
                    ...
                    echo "<p>User <strong>$username</strong> has been banned.</p>";
                }

                if ($qid_ban) {
                    $sql_ban = "INSERT INTO banned_posts VALUES (?);";
                    ...
                    echo "<p>Question <strong>$title</strong> has been banned.</p>";
                }
                 ?>
                <p class="error"></p>
                <p class="success"></p>
